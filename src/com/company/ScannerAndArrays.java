...
//        String somethingFirst = scanner.next();
//
//        System.out.print("Enter something else: ");
//        String somethingSecond = scanner.next();
//
//        if (somethingFirst == somethingSecond){
...
//            rString += "r"; // or do this: rString = rString + "r"; // append r's to the rString
//        }
